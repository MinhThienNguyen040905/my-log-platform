...
import { AiReflectionDrawer } from '@/components/journal/AiReflectionDrawer';
import { ConfirmReflectModal } from '@/components/journal/ConfirmReflectModal';
import { PhotoPreviewModal } from '@/components/journal/PhotoPreviewModal';
import {
  ArrowLeft,
  Sparkles,
  Save,
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-2 flex items-start justify-center transition-all duration-300">
        ...
        <div
          className={`w-full transition-all duration-300 ${
            isAiDrawerOpen ? 'lg:max-w-3xl lg:mr-[380px]' : 'max-w-[850px]'
          }`}
        >
