...
import com.mylog.analysis.infrastructure.persistence.AnalysisJobRepository.JournalInput;
...
public class AnalysisWorker {
    ...
    private void process(AnalysisJob job) {
        ...
        DeterministicSafetyPolicy.SafetyDecision safety = safetyPolicy.evaluate(journal.content());
    ...
    private AiAnalysisOutput safetyOnlyOutput(DeterministicSafetyPolicy.SafetyDecision safety) {
